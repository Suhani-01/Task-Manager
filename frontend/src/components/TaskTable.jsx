                ...
                tasks?.map((task) => (
                  ...
                  >
                    ...
                    <td className="text-center lg:px-2 py-2 px-1">
                      <span
                        className={`px-3 rounded-2xl ${task.priority == "high" ? "bg-danger-light text-danger" : task.priority == "medium" ? "bg-warning-light text-warning" : "bg-success-light text-success"}`}
                      >
                    ...
                    {task._id === activeAction && (
                      <div className="absolute -right-[4%] top-[25%] z-1000 flex flex-col bg-white text-sm p-2 text-center border border-text-muted rounded-lg">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            setActiveAction();
                          ...
                          className="border-b border-text-muted flex gap-1 items-center text-danger cursor-pointer px-3"
                        >
                          <MdDelete />
                          Delete
                        </button>
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            setActiveEditAction(task);
                          }}
                          className="cursor-pointer flex gap-1 justify-center items-center text-primary"
                        >
                          <FaEdit /> Edit
                        </button>
                      </div>
